...
// ********************************************************************
//
// $Id: G4ACDetectorConstruction21.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file G4ACDetectorConstruction21.cc
...
G4ACDetectorConstruction21::G4ACDetectorConstruction21()
: G4ACBaseDetectorConstruction(), fAngleWithTPCedge(12*deg), fDistantFromCenterPMT(150.*mm), fRotationGuide(0)
{
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4ACDetectorConstruction21::G4ACDetectorConstruction21(G4double angleWithTPCedge, G4double distantFromCenterPMT)
: G4ACBaseDetectorConstruction(), fAngleWithTPCedge(angleWithTPCedge), fDistantFromCenterPMT(distantFromCenterPMT)
{
}
...
G4VPhysicalVolume* G4ACDetectorConstruction21::Construct()
{
...
void G4ACDetectorConstruction21::ConstructGuide()
{
  /////////////////////////////////////////////////////////////////
  ...
  G4double guide1In1Xr = 2*fCrossX*cos(fAngleWithTPCedge) - guide1In3Xl;
  ...
  G4VSolid *solidGuide1In1 = new G4GenericTrap("Guide1In1", guide1InZ1 + guide1InZ2, guide1InPtVec);
  ...
  G4UnionSolid *solidGuide1In = new G4UnionSolid("Guide1In", solidGuide1In1, solidGuide1In2, 0, G4ThreeVector(0*mm, 0.5*fBoxThickness, guide1InZ2));
  fGuideInPosVec =
    new G4ThreeVector(G4ThreeVector(0.*mm, 0.*mm, guide1InZ1 + guide1InZ2) - G4ThreeVector(guide1In3Xl - cos(fAngleWithTPCedge)*fCrossX, 0.*mm, sin(fAngleWithTPCedge)*fCrossX));
  ...
  /////////////////////////////////////////////////////////////////  
  G4double guideReflector1OutZ = guide1InZ1 + guide1InZ2 + fReflectorThickness;
  // top face
  ...
  G4VSolid *solidGuideReflector1Out2 = new G4Box("GuideReflector1Out2", guide1InBoxX + fReflectorThickness, 0.51*fBoxThickness, guide1InBoxZ + fReflectorThickness);
  G4UnionSolid *solidGuideReflector1Out = new G4UnionSolid("GuideReflector1Out", solidGuideReflector1Out1, solidGuideReflector1Out2, 0, G4ThreeVector(0*mm, 0.5*fBoxThickness, guide1InZ2));
  ...
  G4ThreeVector tpcEdgeCutPosVec(0.*mm, 0.*mm, guide1InZ2 - guide1InZ1 - tan(fAngleWithTPCedge)*(guide1In3Xl + tpcEdgeCutXr));
  ...
  G4SubtractionSolid *solidGuideCaseWithoutHole = new G4SubtractionSolid("GuideCaseWithoutHole", solidGuideOutBeforeCut, solidGuideReflectorOutBeforeCut, 0, *fGuideReflectorPosVec - *fGuideOutPosVec);
...
void G4ACDetectorConstruction21::ConstructScorer()
{
  /////////////////////////////////////////////////////////////////
...
void G4ACDetectorConstruction21::ConstructInnerAir()
{
  fSolidIn        = new G4UnionSolid("In", fSolidHolderIn, fSolidGuideIn, fRotationGuide, *fGuideInPosVec - *fHolderInPosVec);
