...
// ********************************************************************
//
// $Id: G4ACDetectorConstruction34.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file G4ACDetectorConstruction34.cc
...
G4ACDetectorConstruction34::G4ACDetectorConstruction34()
...
G4VPhysicalVolume* G4ACDetectorConstruction34::Construct()
{
...
void G4ACDetectorConstruction34::ConstructHolderBoundary()
{
...
void G4ACDetectorConstruction34::ConstructGuideBoundary()
{
  // photon energy definition
  const G4int nEntries = 20;
  const G4double pEmin = 1.9074*eV;
