...
// ********************************************************************
//
// $Id: G4ACDetectorConstruction23.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file G4ACDetectorConstruction23.cc
...
G4ACDetectorConstruction23::G4ACDetectorConstruction23()
...
G4VPhysicalVolume* G4ACDetectorConstruction23::Construct()
{
...
void G4ACDetectorConstruction23::ConstructHolderBoundary()
{
  ...
  opInHolderCaseSurface->SetFinish(polished); // mechanically grounded surface, with esr film & meltmount
...
void G4ACDetectorConstruction23::ConstructGuideBoundary()
{
  // photon energy definition
  const G4int nEntries = 20;
  const G4double pEmin = 1.9074*eV;
  ...
  G4LogicalBorderSurface *logicSurfaceInGuideCase = new G4LogicalBorderSurface("InGuideCaseSurface",
    fPhysIn, fPhysGuideCase, opInGuideCaseSurface);  
...
void G4ACDetectorConstruction23::ConstructMaterial()
{
  ...
  MPTreflector->AddConstProperty("SCINTILLATIONYIELD", 0.27*5000./MeV);
