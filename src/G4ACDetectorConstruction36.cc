...
// ********************************************************************
//
// $Id: G4ACDetectorConstruction36.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file G4ACDetectorConstruction36.cc
...
G4ACDetectorConstruction36::G4ACDetectorConstruction36()
...
G4VPhysicalVolume* G4ACDetectorConstruction36::Construct()
{
...
void G4ACDetectorConstruction36::ConstructHolderBoundary()
{
...
void G4ACDetectorConstruction36::ConstructGuideBoundary()
{
  // photon energy definition
  const G4int nEntries = 20;
  const G4double pEmin = 1.9074*eV;
