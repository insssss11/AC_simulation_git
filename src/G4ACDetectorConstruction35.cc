...
// ********************************************************************
//
// $Id: G4ACDetectorConstruction35.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file G4ACDetectorConstruction35.cc
...
G4ACDetectorConstruction35::G4ACDetectorConstruction35()
...
G4VPhysicalVolume* G4ACDetectorConstruction35::Construct()
{
...
void G4ACDetectorConstruction35::ConstructHolderBoundary()
{
...
void G4ACDetectorConstruction35::ConstructGuideBoundary()
{
  // photon energy definition
  const G4int nEntries = 20;
  const G4double pEmin = 1.9074*eV;
