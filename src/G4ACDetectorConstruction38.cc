...
// ********************************************************************
//
// $Id: G4ACDetectorConstruction38.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file G4ACDetectorConstruction38.cc
...
G4ACDetectorConstruction38::G4ACDetectorConstruction38()
...
G4VPhysicalVolume* G4ACDetectorConstruction38::Construct()
{
...
void G4ACDetectorConstruction38::ConstructHolderBoundary()
{
...
void G4ACDetectorConstruction38::ConstructGuideBoundary()
{
  // photon energy definition
  const G4int nEntries = 20;
  const G4double pEmin = 1.9074*eV;
